...
(function ($) {
    ...
    SelectPage.prototype.getOption = function () {
        return this.option;
    };
    ...
    SelectPage.prototype.setElem = function (combo_input) {
        ...
        var hidden = elem.container.parent().find(".hidden_model");
        if (hidden.length > 0) {
            elem.hidden = hidden;
            elem.hidden .attr({
                name: hidden_name,
    ...
    SelectPage.prototype.searchForDb = function (self, q_word, which_page_num) {
        ...
        if (_paramsFunc) {
            var result = $.isFunction(_paramsFunc) ? _paramsFunc() : eval("(" +  _paramsFunc + ")");
    ...
    $.fn.selectPageDataUrl = ModifyDataUrl;
