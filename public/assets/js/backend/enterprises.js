define(['jquery', 'backend', 'table', 'form','template','angular','cosmetic'], function ($, Backend, Table, Form, Template,angular, Cosmetic) {
    var Controller = {
        indexscape:function($scope, $compile,$timeout){
            ...
            var options = {
                extend: {
                    index_url: 'enterprises/index',
                    add_url: 'enterprises/add',
                    del_url: 'enterprises/del',
                    multi_url: 'enterprises/multi',
                    summation_url: 'enterprises/summation',
                    table: 'enterprises',
                },
                buttons : [
                    {
        ...
        viewscape:function($scope, $compile,$parse, $timeout){
            $scope.refreshRow = function(){
                $.ajax({url: "enterprises/index",dataType: 'json',
                    data:{
                        custom: {"enterprises.id":$scope.row.id}
                    },
