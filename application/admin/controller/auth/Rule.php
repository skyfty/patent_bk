...
class Rule extends Backend
{
    ...
    public function edit($ids = null)
    {
        ...
        if ($this->request->isPost()) {
            ...
            if ($params) {
                ...
                if ($ruleValidate->check($params) === false) {
    ...
    protected function enumtree($id, &$chequelList) {
        $list = $this->model->where('pid', $id)->order("weigh asc")->select();
        foreach ($list as $k => $v) {
            $item = [
                'id' => $v['id'],
                'isParent' => true,
            ...
            $item['children'] = [];
            $this->enumtree($v['id'], $item['children']);
            $chequelList[] = $item;
        }
    }
